...
const PAGES: Page[] = [
  ...
  { id: 'ui', title: 'UI Overlay', file: '/pages/ui-overlay.md' },
  { id: 'storage', title: 'Storage', file: '/pages/storage.md' },
  { id: 'particles', title: 'Particles', file: '/pages/particles.md' },
  { id: 'plugins', title: 'Plugins', file: '/pages/plugins.md' },
